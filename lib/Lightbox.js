...
var Lightbox = function (_Component) {
	...
	_createClass(Lightbox, [{
		...
		value: function renderImages() {
			...
			var el = void 0;
			if (image.youtubeId) {
				el = _react2.default.createElement('iframe', { width: '720', height: '405', src: 'https://www.youtube.com/embed/' + image.youtubeId, frameBorder: '0', allow: 'autoplay; encrypted-media', allowFullScreen: true });
			} else if (image.vimeoId) {
				el = _react2.default.createElement('iframe', { src: 'https://player.vimeo.com/video/' + image.vimeoId, width: '640', height: '360', frameBorder: '0', webkitallowfullscreen: true, mozallowfullscreen: true, allowFullScreen: true });
			} else if (image.component) {
				el = image.component;
			} else {
				el = _react2.default.createElement('img', {
...
Lightbox.propTypes = {
	...
	images: _propTypes2.default.arrayOf(_propTypes2.default.shape({
		...
		vimeoId: _propTypes2.default.string,
